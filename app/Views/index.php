                    ...
                    <li class="nav-item dropdown ">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <?php if (session()->get('email')) { ?>
                                <a href="#" class="dropdown-item">
                                    <i class="fas fa-user-circle mr-2 fa-fw text-info"></i> My Profile
                                </a>

                                <div class="dropdown-divider"></div>
                                <a href="/admin/dashboard" class="dropdown-item">
                                    <i class="fas fa-tachometer-alt mr-2 fa-fw text-info"></i> Dashboard
                                </a>

                                <div class="dropdown-divider"></div>
                                <a href="" class="dropdown-item" data-toggle="modal" data-target="#modal-logout">
                                    <i class="fas fa-sign-out-alt mr-2 fa-fw text-info"></i> Logout
                                </a>
                            <?php } else { ?>

                                <a href="/auth" class="dropdown-item">
                                    <i class="fas fa-user-circle mr-2 fa-fw text-info"></i> Login
                                </a>
                            <?php } ?>
                        </div>
                    </li>
